...
public class kitkat extends Activity implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_portal);
		   Intent iin= getIntent();
	    	 ...
	    	 final DataViewerSQLiteHelper stockSQLHelper = new DataViewerSQLiteHelper(kitkat.this);
	...
	private void setupBrowser(String url) {
	 ...
	 myWebView.setVisibility(View.INVISIBLE);
		...
		myWebChromeClient = new MyWebChromeClient(kitkat.this, childLayout, browserLayout, titleText);
...
view.loadUrl("https://customer.onlinelic.in/LICEPS/appmanager/Agent/AgentHome?_nfpb=true&_windowLabel=agentCustomerTrackingToolsPortletInstance1&_cuid=RC_t_848078&_pagechange=AgtLapsedPolicyDetails");
		...
		//			 myWebView.loadUrl(ht1);	
			//		 myWebView.evaluateJavascript("(function() {window.variable =  document.getElementsByClassName(\"pagingLabel\")[1].innerHTML; })();", new ValueCallback<String>() {
						view.evaluateJavascript("javascript : var pag =  document.getElementsByClassName(\"pagingLabel\")[1].innerHTML;return pag", new ValueCallback<String>() {
							    @Override
...
public void displayalert(String hhhhh){
  ...
  alert.show();
	...
	Toast.makeText(kitkat.this, "No.Of Pages "+String.valueOf(noofpages), Toast.LENGTH_SHORT).show();	
	
	
	
	
	kitkat.this.runOnUiThread(new Runnable() {
	    public void run() {
	...
	//			 Toast.makeText(PortalrevList.this, "No.Of Pages "+String.valueOf(noofpages), Toast.LENGTH_SHORT).show();		
				...
				ht =  "javascript:window.droid.print(document.getElementsByTagName('html')[0].innerHTML);";
					myWebView.loadUrl(ht);
					 ...
					 AlertDialog.Builder alert = new AlertDialog.Builder(kitkat.this); 
					  alert.setTitle("Lapsed List");
