...
public class FirstPdf extends Activity {
	 private static String FILE = "FirstPdf.pdf";
	String yourFile = Environment.getExternalStorageDirectory() + "/download/" + FILE; 
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.first_pdf, menu);
		return true;
	}
