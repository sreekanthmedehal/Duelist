...
public class DoctorLocator extends Activity implements View.OnClickListener {
	  WebView myWebView;
	  ProgressDialog pd;
	  String j2;
		...
		myWebView = (WebView) findViewById(R.id.webView1);
		  AlertDialog.Builder alert = new AlertDialog.Builder(this);
			...
			j2 = input.getText().toString();         
				...
				setUpWidgets();
				setupBrowser("http://www.licindia.in/LICEPS/portlets/visitor/DoctorLocator/begin.do");          
			}
			});
    ...
    //    myWebView.setVisibility(View.INVISIBLE);
		...
		myWebView.setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView view, String url) {
				...
				if (url.contains("DoctorLocator")) {
	//Toast.makeText(DoctorLocator.this, url, Toast.LENGTH_LONG).show();
		view.loadUrl("javascript: {" +
				 "document.getElementsByName(\"{actionForm.station}\")[0].value = '"+ j2 +"';" +
				...
				if (url.contains("getDoctorsList")) {
					  pd.dismiss();
